...
import app.graphcis.CalibratedOcrGraphic
import app.graphcis.OcrGraphic
import app.graphcis.PreviewOcrGraphic


import injection.PiFloorApplication
import camera.OcrGraphicOverlay
import com.google.firebase.events.Subscriber
import javax.inject.Inject

class CalibrationModeActivity : AppCompatActivity(), OcrCaptureFragment.OcrSelectionListener,
    com.google.firebase.events.Subscriber<ArrayList<TextBlock>> {
    @Inject
    ...
    private fun displaySnackbar(text: String?, actionName: String?, action: View.OnClickListener?) {
        val snack: Snackbar = Snackbar.make(findViewById(R.id.content), text!!, Snackbar.LENGTH_LONG)
